...
| | Where | Status |
|---|---|---|
| App Store Connect app record for `com.almonium.mobile` | ASC → My Apps; Apple ID `6813826846`, set as `submit.production.ios.ascAppId` in `eas.json` for the `--non-interactive` CI submit | done |
